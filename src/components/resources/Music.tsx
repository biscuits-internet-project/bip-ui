		...
		<>
			...
			<Card>
				<CardContent>
					...
					<Typography variant="body2">An inverted version of a song will almost always happen when they jam out of a different song (Song B), and segue the jam into the ending section of Song A. At the exact point of the ending of Song A, they immediately play the beginning of Song A, then the jam section, which usually segues into a different song (Song C), or the song that proceeded the inverted song (Song B).</Typography>

					<Typography variant="h3">Examples:</Typography>
					<Typography variant="body2">Standard Version of a song:</Typography>
					<Typography variant="body2">
						Song A (Beg.) -> Jam ->Song A (End)
				    </Typography>
					<Typography variant="body2">Inverted Version:</Typography>
					<Typography variant="body2">Song B -> Jam -> Song A (End) -> Song A (Beg.) -> Jam -> Song C</Typography>
			...
			<Card>
				<CardContent>
					...
					<Typography variant="h3">Examples:</Typography>
					<Typography variant="body2">Song A -> Jam -> Song B (End), Song C, Song B (Beg.) -> Song D</Typography>
