	...
	return (
		<>
			...
			<Card>
				...
				<CardContent>
					<Typography variant="body2">Coming soon - this shit don't write itself.  Follow us at <Link href="https://twitter.com/tdbdotnet" target="blank">@tdbdotnet</Link> for content updates!</Typography>
				</CardContent>
			</Card>
			{divider}
			<Card>
