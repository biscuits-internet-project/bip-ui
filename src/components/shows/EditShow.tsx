                ...
                {show && show.tracks.map((track) => {
                  return (
                    <TableRow>
                      ...
                      <TableCell>
                        <Button onClick={() => handleOpenTrackForm(track)}>Edit</Button> <Button onClick={() => window.confirm("Are you sure you want to delete this track?") && deleteTrack(track)}>Delete</Button>
                      </TableCell>
                    </TableRow>
                  )
                })}
