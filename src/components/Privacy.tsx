...
const Privacy: React.FC = () => {
  return (
    <>
      ...
      <Paragraph>
        Your privacy is important to us. It is Biscuits Internet Project's
        policy to respect your privacy regarding any information we may collect
        from you across our website, http://discobiscuits.net, and other sites
        we own and operate.
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>This policy is effective as of 1 March 2020.</Paragraph>
    </>
  )
}
